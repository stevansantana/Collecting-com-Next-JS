...
export default function Page() {
  return (
    <section className='mb-14 mt-14'>
      <h1 className='text-center text-2xl'>Bem vindo ao Collecting</h1>
      <p className='mt-10 pl-10 pr-10 text-center text-sm leading-10'>
      ...
      <div className='mt-16 flex justify-center items-center flex-col'>
        <Link
          className='w-36 mb-6 rounded-lg bg-blue-600 p-5 text-center font-bold text-white hover:bg-black'
          href='/ui/home'
        >
          Entrar
        </Link>
